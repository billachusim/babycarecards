...
export const Route = createFileRoute("/refunds")({
  head: () =>
    publicHead({
      title: "Refund Policy — Baby Care Cards",
      description:
        "Baby Care Cards offers a 30-day money-back guarantee on the one-time $4.99 lifetime unlock. Refunds are handled directly by Tech Faculty.",
      path: "/refunds",
    }),
  ...
  return (
    <AppShell>
      ...
      <article className="space-y-5 rounded-3xl border border-border bg-card p-6 leading-relaxed">
        ...
        <p>
          Baby Care Cards is sold by <strong>Tech Faculty</strong> as a one-time $4.99 lifetime
        ...
        <p>
          ...
          unlock is deactivated and premium features return to the free tier. Children and care cards
