...
export const Route = createFileRoute("/c/$token")({
  head: () => ({
    meta: [
      ...
      { title: "Shared Care Card — Baby Care Cards" },
      {
        name: "description",
        content:
          "A child care card shared by its owner: feeding, routine, medication, emergency contacts and pediatrician details.",
      },
      { property: "og:title", content: "Shared Baby Care Cards" },
      {
        property: "og:description",
        content: "Everything a sitter needs to look after this child, shared by the owner.",
      },
    ],
  }),
    ...
    <AppShell>
      ...
      <div className="no-print mt-8 rounded-3xl border border-border bg-card p-6 text-center">
        <p className="text-sm text-muted-foreground">
          Shared with you by {state.card.child.name}&apos;s owner. Print this page to keep a paper copy.
        </p>
