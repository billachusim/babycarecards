...
export const Route = createFileRoute("/contact")({
  head: () =>
    publicHead({
      title: "Contact Baby Care Cards — Support from Tech Faculty",
      description:
        "Contact the Baby Care Cards team at Tech Faculty for product support, billing questions, refunds or privacy requests. We reply to every email within two business days.",
      path: "/contact",
    }),
    ...
    <AppShell>
      ...
      <section className="space-y-6 text-sm">
        <div className="rounded-3xl border border-border bg-card p-6">
          ...
          <p className="mt-2 text-muted-foreground">
            Email{" "}
            <a href="mailto:support@babycarecards.app" className="font-medium text-foreground underline">
        ...
        <div className="rounded-3xl border border-border bg-card p-6">
          ...
          <p className="mt-2 text-muted-foreground">
            Tech Faculty, trading as {SITE_NAME}. Website: babycarecards.app. All correspondence is
            handled by email at support@babycarecards.app.
          </p>
        </div>
      </section>
    </AppShell>
