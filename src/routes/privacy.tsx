...
export const Route = createFileRoute("/privacy")({
  head: () =>
    publicHead({
      title: "Privacy Notice — Baby Care Cards",
      description:
        "How Tech Faculty handles personal data in Baby Care Cards: what we collect, why, who we share it with (including Flutterwave as payment processor), retention, security and your rights.",
      path: "/privacy",
    }),
  ...
  return (
    <AppShell>
      ...
      <article className="space-y-5 rounded-3xl border border-border bg-card p-6 leading-relaxed">
        ...
        <p>
          Baby Care Cards is operated by <strong>Tech Faculty</strong> (&ldquo;we&rdquo;,
          ...
          <a className="underline" href="mailto:support@babycarecards.app">
            support@babycarecards.app
          </a>
          .
        </p>

        <h2 className="font-display text-xl font-semibold">Child data stays on your device</h2>
        <p>
          Children, care details, photos, medications and reminders you enter are stored in your
        ...
        <p>
          ...
          you can restore it on another device: child names, ageGroup, allergies, age, photos, feeding,
          routine, medication, emergency contact, pediatrician, reminder and caregiver details,
        ...
        <p>
          We use this data to provide backup and restore, and to improve Baby Care Cards. We do not
          ...
          identify you, your household, or an individual child.
        </p>
        <p>
        ...
        <p>
          ...
          not process child health information on our servers.
        </p>

        <h2 className="font-display text-xl font-semibold">Cookies and local storage</h2>
        <p>
          We use only essential browser storage: local storage to keep your children, care cards and
        ...
        <p>
          ...
          never your child&apos;s details. Sharing is always initiated by you.
        </p>
        ...
        <p>
          ...
          requests: <a className="underline" href="mailto:support@babycarecards.app">support@babycarecards.app</a>.
