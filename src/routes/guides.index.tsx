...
const TITLE = "Caregiver Guides — Preparing a Babysitter to Look After Your Child";
const DESCRIPTION =
  "Practical guides for handing your baby or toddler over to a babysitter, grandparent or daycare: care card checklists, feeding schedules, medication notes and emergency contact sheets.";
    ...
    <AppShell>
      ...
      <header className="rounded-3xl border border-border bg-card p-6">
        ...
        <h1 className="mt-4 font-display text-3xl leading-tight font-semibold sm:text-4xl">
          Everything to hand over before a babysitter looks after your child
        </h1>
        <p className="mt-3 text-base leading-relaxed text-muted-foreground">
          Short, practical guides for the days before you leave your baby or toddler with someone else — what to write down, what to leave out,
          and how to make sure a babysitter can find it under pressure. Each one ends with a care card you
