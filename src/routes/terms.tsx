...
export const Route = createFileRoute("/terms")({
  head: () =>
    publicHead({
      title: "Terms of Use — Baby Care Cards",
      description:
        "The terms between you and Tech Faculty for Baby Care Cards, covering acceptable use, the one-time $4.99 lifetime unlock, Flutterwave as payment processor, and the no-medical-advice policy.",
      path: "/terms",
    }),
  component: TermsPage,
});
  ...
  return (
    <AppShell>
      ...
      <article className="space-y-5 rounded-3xl border border-border bg-card p-6 leading-relaxed">
        ...
        <p>
          Baby Care Cards (the &ldquo;Service&rdquo;) is provided by <strong>Tech Faculty</strong>{" "}
          (&ldquo;we&rdquo;, &ldquo;us&rdquo;). These Terms form an agreement between you and Tech
          Faculty. Contact:{" "}
          <a className="underline" href="mailto:support@babycarecards.app">support@babycarecards.app</a>.
        </p>
        ...
        <p>
          Baby Care Cards is an organisational tool. It stores the child care instructions you enter and
        ...
        <p>
          ...
          own child care purposes, within the plan you have. You may not resell or redistribute the
        ...
        <p>
          ...
          that do not identify you or your children, as described in the Privacy Policy.
        </p>
        ...
        <p>
          ...
          pediatrician for advice about your child&apos;s health or treatment.
        </p>
