 ...
 *
 * The QR code intentionally encodes only a route + identifier (never raw child
...
export function buildCareCardUrl(childId: string): string {
  const origin = typeof window !== "undefined" ? window.location.origin : "";
  return `${origin}/care/${childId}`;
}
