...
export const Route = createFileRoute("/premium")({
  head: () => ({
    meta: [
      ...
      { title: "Unlock Lifetime — Baby Care Cards" },
      {
        name: "description",
        content:
          "One payment of $4.99 unlocks unlimited children, medication schedules, reminders, printable care cards, PDF export and sharing. No subscription.",
      },
      { property: "og:title", content: "Unlock Lifetime — Baby Care Cards" },
    ...
    <AppShell>
      ...
      <div className="rounded-3xl border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Keep everything ready for your child&apos;s caregiver. The free plan covers one child with a
