...
export const Route = createFileRoute("/onboarding")({
  head: () => ({
    meta: [
      ...
      { title: "Welcome to Baby Care Cards" },
      {
        name: "description",
        content:
          "Three quick steps to a care card your babysitter can follow: what to know, what's inside, and how to share it.",
      },
      { property: "og:title", content: "Welcome to Baby Care Cards" },
      {
...
const SLIDES = [
  {
    icon: HeartHandshake,
    title: "Leaving your child with someone?",
  ...
  },
  {
    ...
    bullets: ["Feeding", "Medication", "Routine", "Emergency contacts", "Pediatrician information"],
  },
  {
    icon: Share2,
    ...
    <AppShell bare>
      <div className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-between py-10">
        ...
        <div className="mt-12 space-y-5">
          ...
          >
            {isLast ? "Create My Baby Care Cards" : "Continue"}
          </Button>
          {!isLast && (
