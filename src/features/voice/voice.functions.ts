  ...
  return {
    child: {
      ...(pick("child", [
        ...
        "personality",
        "thingsToKnow",
      ]) as ParsedCareDetails["child"]),
      ageGroup: oneOf(source["child"]?.["ageGroup"], ["Newborn", "Infant", "Toddler", "Preschooler", "School age", "Other"] as const),
      sex: oneOf(source["child"]?.["sex"], ["Boy", "Girl", "Prefer not to say"] as const),
    },
    ...
    pediatrician: pick("pediatrician", [
      "doctorName",
      "clinicName",
      "phone",
      "address",
    ]) as ParsedCareDetails["pediatrician"],
  };
}
