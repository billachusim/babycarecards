...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      ...
      { title: "Settings — Baby Care Cards" },
      {
        name: "description",
        content:
          "Manage premium status, notifications, data export and local data for Baby Care Cards.",
      },
      { property: "og:title", content: "Settings — Baby Care Cards" },
    ...
    <AppShell>
      ...
      <div className="mt-6 divide-y divide-border rounded-3xl border border-border bg-card px-5">
        <Row>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {isPremium ? "Lifetime access active" : "Free plan — one child"}
            </p>
          </div>
          {!isPremium && (
          ...
          <Button
            ...
            onClick={() => {
              try {
                ...
                downloadDataUrl(URL.createObjectURL(blob), "child-care-card-backup.json");
        ...
        <Row>
          <div>
            ...
            <p className="text-sm text-muted-foreground">Removes every child and care card here.</p>
          </div>
      ...
      <div className="mt-6 divide-y divide-border rounded-3xl border border-border bg-card px-5">
        ...
        <Row>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Baby Care Cards helps you hand over everything a caregiver needs. Your data stays on
              this device.
            </p>
          </div>
        </Row>
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent className="rounded-3xl">
          <AlertDialogHeader>
            <AlertDialogTitle>Delete all child data?</AlertDialogTitle>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() => {
                deleteAllData();
                toast.success("All child data deleted.");
                void navigate({ to: "/" });
              }}
            >
              Delete
