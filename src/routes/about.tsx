...
const TITLE = "About Baby Care Cards";
const DESCRIPTION =
  "Baby Care Cards is made by Tech Faculty. Learn who builds the app, how the caregiver guides are written and reviewed, how child data is handled, and how to get in touch.";
  ...
  return (
    <AppShell>
      ...
      <h1 className="font-display text-3xl leading-tight font-semibold sm:text-4xl">
        About Baby Care Cards
      </h1>
      <p className="mt-4 text-base leading-relaxed">
        Baby Care Cards is a small web tool for one specific moment: the day you hand your child over to
        a babysitter, a family member or a daycare provider. It collects feeding, routine, medication,
        emergency and pediatrician details into one readable card you can share by link, print, or show as a
        QR code — in about two minutes, with no account.
      </p>
      <p className="mt-3 text-base leading-relaxed">
        If typing it all out is the part you dread, you can{" "}
        <Link to="/talk-about-your-child" className="text-primary hover:underline">
      ...
      <p className="mt-3 text-base leading-relaxed">
        Baby Care Cards is built and published by {BUSINESS_NAME}, an independent software studio.
        {" "}
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-base leading-relaxed">
        <li>
          Every guide is written by the Baby Care Cards team from the practical handover problems
        ...
        <li>
          ...
          never recommend medications or dosages — anything clinical is your pediatrician&apos;s call.
        </li>
        <li>
      ...
      <h2 className="mt-10 font-display text-2xl font-semibold">How your child&apos;s data is handled</h2>
      <p className="mt-3 text-base leading-relaxed">
        Child details are stored locally in your own browser. There is no account, and nothing about
        your child is uploaded unless you explicitly share or export it. Purchase entitlement is
        verified on our server and kept separately from child data. The{" "}
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-base leading-relaxed">
        <li>Not a pediatrician service, and not a source of medical advice</li>
      ...
      <p className="mt-3 text-base leading-relaxed">
        ...
        <a href="mailto:support@babycarecards.app" className="text-primary hover:underline">
          support@babycarecards.app
        </a>
        .
      </p>
